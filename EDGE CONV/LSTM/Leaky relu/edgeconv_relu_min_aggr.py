# -*- coding: utf-8 -*-
"""Vish edit edgeconv: BTP_WITH_AOD.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UcV4o65GDbIZfThf2u4P3xFspWWsJpG-
"""
...
Hour_3_sample=np.load("/content/drive/MyDrive/BTP-03/DATASET/Dataset.npy", allow_pickle = True)
...
u = Hour_3_sample[:, :, -2] * units.meter / units.second
v = Hour_3_sample[:, :, -1] * units.meter / units.second
speed = mpcalc.wind_speed(u, v)._magnitude
direc = mpcalc.wind_direction(u, v)._magnitude

Hour_3_sample.shape

Hour_3_sample[:,:, -2] = speed
Hour_3_sample[:,:,-1] = direc

#np.save("/content/drive/MyDrive/BTP-03/DATASET/Dataset_With_WSWD.npy", Hour_3_sample)
...
class PM25_GNN(nn.Module):
    def __init__(self, hist_len, pred_len, in_dim, city_num, batch_size, device, edge_index, edge_attr, wind_mean, wind_std):
        ...
        # print(self.edge_conv)
        self.lstm_cell = LSTMCell(self.in_dim + 2*self.gnn_out, self.hid_dim)
...
def train(train_loader, model, optimizer):
    ...
    for batch_idx, data in tqdm(enumerate(train_loader)):
        ...
        with autocast():
            ...
            #  print("train pred: ",pm25_pred.shape)
...
Train epoch 0:
812it [06:10,  2.19it/s]
train_loss: 0.5939
09/07 10:56:18 AM | Epoch: 0/0.594---Train,0.583----Test,RMSE34.079,NRMSE0.0377,MAE29.989,R20.542,CSI0.617,POD0.891,FAR0.332

INFO:gal:Epoch: 0/0.594---Train,0.583----Test,RMSE34.079,NRMSE0.0377,MAE29.989,R20.542,CSI0.617,POD0.891,FAR0.332

pred (1725, 8, 266)
lab (1725, 8, 266)
Save model: /content/drive/MyDrive/BTP-03/PM25-GNN/Results/16_8/PM2.5-GNN/20230907104815/00/0/model.pth
Train loss: 0.5939, Test loss: 0.5830, RMSE: 34.08,NRMSE: 0.0377, MAE: 29.99,R2: 0.5421, CSI: 0.6175, POD: 0.8913, FAR: 0.3322
"""
...
Train loss: 0.5882, Test loss: 0.5789, RMSE: 31.74, NRMSE:0.04 ,MAE: 27.60, R2: 0.55, CSI: 0.6573, POD: 0.8439, FAR: 0.2517
=========================

---------------------------------------
train_loss | mean: 0.5882 std: 0.0000
test_loss  | mean: 0.5789 std: 0.0000
RMSE       | mean: 31.7412 std: 0.0000
MAE        | mean: 27.5975 std: 0.0000
CSI        | mean: 0.6573 std: 0.0000
POD        | mean: 0.8439 std: 0.0000
FAR        | mean: 0.2517 std: 0.0000
R2         | mean: 0.5452 std: 0.0000
...
pred (1725, 8, 266)
lab (1725, 8, 266)
Save model: /content/drive/MyDrive/BTP-03/PM25-GNN/Results/16_8/PM2.5-GNN/20230907112716/00/0/model.pth
Train loss: 0.5964, Test loss: 0.5556, RMSE: 31.23,NRMSE: 0.0345, MAE: 27.09,R2: 0.5636, CSI: 0.6441, POD: 0.8467, FAR: 0.2708

No. 0 experiment results:
Train loss: 0.5964, Test loss: 0.5556, RMSE: 31.23, NRMSE:0.03 ,MAE: 27.09, R2: 0.56, CSI: 0.6441, POD: 0.8467, FAR: 0.2708
=========================

---------------------------------------
train_loss | mean: 0.5964 std: 0.0000
test_loss  | mean: 0.5556 std: 0.0000
RMSE       | mean: 31.2334 std: 0.0000
MAE        | mean: 27.0854 std: 0.0000
CSI        | mean: 0.6441 std: 0.0000
POD        | mean: 0.8467 std: 0.0000
FAR        | mean: 0.2708 std: 0.0000
R2         | mean: 0.5636 std: 0.0000
...
No. 0 experiment results:
Train loss: 0.5889, Test loss: 0.5683, RMSE: 30.32, NRMSE:0.03 ,MAE: 25.89, R2: 0.55, CSI: 0.6240, POD: 0.7287, FAR: 0.1871
=========================

---------------------------------------
train_loss | mean: 0.5889 std: 0.0000
test_loss  | mean: 0.5683 std: 0.0000
RMSE       | mean: 30.3186 std: 0.0000
MAE        | mean: 25.8872 std: 0.0000
CSI        | mean: 0.6240 std: 0.0000
POD        | mean: 0.7287 std: 0.0000
FAR        | mean: 0.1871 std: 0.0000
R2         | mean: 0.5538 std: 0.0000
learningRate... 0.0015weight_decay 0.0001
...
No. 0 experiment results:
Train loss: 0.5894, Test loss: 0.6339, RMSE: 39.51, NRMSE:0.04 ,MAE: 35.57, R2: 0.50, CSI: 0.5429, POD: 0.9535, FAR: 0.4423
=========================

---------------------------------------
train_loss | mean: 0.5894 std: 0.0000
test_loss  | mean: 0.6339 std: 0.0000
RMSE       | mean: 39.5136 std: 0.0000
MAE        | mean: 35.5664 std: 0.0000
CSI        | mean: 0.5429 std: 0.0000
POD        | mean: 0.9535 std: 0.0000
FAR        | mean: 0.4423 std: 0.0000
R2         | mean: 0.5021 std: 0.0000
learningRate... 0.0015weight_decay 0.0001

# Soft Max R2: 0.53
No. 0 experiment results:
Train loss: 0.5944, Test loss: 0.5939, RMSE: 32.45, NRMSE:0.04 ,MAE: 28.33, R2: 0.53, CSI: 0.6456, POD: 0.8493, FAR: 0.2708
=========================

---------------------------------------
train_loss | mean: 0.5944 std: 0.0000
test_loss  | mean: 0.5939 std: 0.0000
RMSE       | mean: 32.4477 std: 0.0000
MAE        | mean: 28.3303 std: 0.0000
CSI        | mean: 0.6456 std: 0.0000
POD        | mean: 0.8493 std: 0.0000
FAR        | mean: 0.2708 std: 0.0000
R2         | mean: 0.5335 std: 0.0000
learningRate... 0.0015weight_decay 0.0001
"""



"""# lstm cell pm25 gnn  min aggr R20.552


Train epoch 0:
812it [06:32,  2.07it/s]
train_loss: 0.6075
09/07 01:17:35 PM | Epoch: 0/0.608---Train,0.571----Test,RMSE34.746,NRMSE0.0384,MAE30.751,R20.552,CSI0.609,POD0.920,FAR0.357

# sigmoid+relu+min R2         | mean: 0.5449

train_loss | mean: 0.6089 std: 0.0000
test_loss  | mean: 0.5794 std: 0.0000
RMSE       | mean: 34.4668 std: 0.0000
MAE        | mean: 30.3589 std: 0.0000
CSI        | mean: 0.6083 std: 0.0000
POD        | mean: 0.8958 std: 0.0000
FAR        | mean: 0.3453 std: 0.0000
R2         | mean: 0.5449 std: 0.0000
learningRate... 0.0015weight_decay 0.0001

##Leaky relu +min + lstm cell R2: 0.58
pred (1725, 8, 266)
lab (1725, 8, 266)
Save model: /content/drive/MyDrive/BTP-03/PM25-GNN/Results/16_8/PM2.5-GNN/20230908063129/00/0/model.pth
Train loss: 0.6113, Test loss: 0.5372, RMSE: 29.76,NRMSE: 0.0329, MAE: 25.54,R2: 0.5780, CSI: 0.6490, POD: 0.7828, FAR: 0.2085

No. 0 experiment results:
Train loss: 0.6113, Test loss: 0.5372, RMSE: 29.76, NRMSE:0.03 ,MAE: 25.54, R2: 0.58, CSI: 0.6490, POD: 0.7828, FAR: 0.2085
=========================

---------------------------------------
train_loss | mean: 0.6113 std: 0.0000
test_loss  | mean: 0.5372 std: 0.0000
RMSE       | mean: 29.7641 std: 0.0000
MAE        | mean: 25.5421 std: 0.0000
CSI        | mean: 0.6490 std: 0.0000
POD        | mean: 0.7828 std: 0.0000
FAR        | mean: 0.2085 std: 0.0000
R2         | mean: 0.5780 std: 0.0000
"""
...
"""# LEAKY RELU EDGE CONV RES 0.01 min aggr R2 0.54

No. 0 experiment results:
Train loss: 0.6186, Test loss: 0.5797, RMSE: 33.97, NRMSE:0.04 ,MAE: 29.97, R2: 0.54, CSI: 0.6226, POD: 0.9059, FAR: 0.3343
=========================

#Leaky edge conv 0.001 lstm cell min aggr r2 0.58

No. 0 experiment results:
Train loss: 0.6038, Test loss: 0.5392, RMSE: 30.77, NRMSE:0.03 ,MAE: 26.39, R2: 0.58, CSI: 0.6273, POD: 0.7353, FAR: 0.1897
=========================

# Leaky RELU EDGE CONV max aggr r2 0.56
No. 0 experiment results:
Train loss: 0.5947, Test loss: 0.5557, RMSE: 29.67, NRMSE:0.03 ,MAE: 25.34, R2: 0.56, CSI: 0.6167, POD: 0.7106, FAR: 0.1764
=========================
...
No. 0 experiment results:
Train loss: 0.6037, Test loss: 0.6191, RMSE: 33.15, NRMSE:0.04 ,MAE: 28.93, R2: 0.51, CSI: 0.6499, POD: 0.8222, FAR: 0.2438
=========================

# Leaky softmax R2 0.561
No. 0 experiment results:
Train loss: 0.6088, Test loss: 0.5585, RMSE: 31.04, NRMSE:0.03 ,MAE: 26.93, R2: 0.56, CSI: 0.6570, POD: 0.8071, FAR: 0.2205
=========================
=========================

#Leak relu +relu 0.563 for softmax

No. 0 experiment results:
Train loss: 0.6132, Test loss: 0.5559, RMSE: 30.39, NRMSE:0.03 ,MAE: 25.96, R2: 0.56, CSI: 0.6151, POD: 0.6997, FAR: 0.1642
=========================

#relu min
No. 0 experiment results:
Train loss: 0.6068, Test loss: 0.5805, RMSE: 30.13, NRMSE:0.03 ,MAE: 25.78, R2: 0.54, CSI: 0.6347, POD: 0.7327, FAR: 0.1741
=========================
"""
