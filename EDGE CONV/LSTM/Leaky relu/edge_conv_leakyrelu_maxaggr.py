# -*- coding: utf-8 -*-
"""Copy of Vish edgeconv: BTP_WITH_AOD.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qPgj9ebZTYXbtWSAWd1GXAq6-Ro92A1J
"""
...
class PM25_GNN(nn.Module):
    def __init__(self, hist_len, pred_len, in_dim, city_num, batch_size, device, edge_index, edge_attr, wind_mean, wind_std):
        ...
        self.pna_conv = PNAConv(in_dim, self.gnn_out, aggregators=['sum', 'mean', 'min', 'max', 'var', 'std'], scalers=['identity', 'amplification', 'linear', 'inverse_linear'],deg="2.5")
    ...
    def forward(self, pm25_hist, feature):
        ...
        for i in range(self.hist_len):
            ...
            edge_xn = self.pna_conv(x, edge_index)
...
"""# without egde conv 1st epochs r2 value with leaky relu

09/08 02:49:20 PM | Epoch: 0/0.593---Train,0.563----Test,RMSE30.795,NRMSE0.0341,MAE26.577,R20.558,CSI0.643,POD0.794,FAR0.228

09/08 02:49:20 PM | Epoch: 0/0.593---Train,0.563----Test,RMSE30.795,NRMSE0.0341,MAE26.577,R20.558,CSI0.643,POD0.794,FAR0.228

INFO:gal:Epoch: 0/0.593---Train,0.563----Test,RMSE30.795,NRMSE0.0341,MAE26.577,R20.558,CSI0.643,POD0.794,FAR0.228
