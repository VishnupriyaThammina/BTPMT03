...
o<-final("C:\\Users\\Santhosh\\Desktop\\modis_india\\2020012.tif")
...
gridded(o) <- TRUE
rasterDF <- raster(o)
writeRaster(rasterDF,"C:\\Users\\Santhosh\\Desktop\\modis_india\\final_ncs\\2020-01-12.tif")

hist(o$z,xlab = "Weight",col = "yellow",border = "blue")
